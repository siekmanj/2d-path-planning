...
waypoint_list, obstacle_list = fieldGen(config.FIELD_WIDTH,
										config.FIELD_HEIGHT,
										config.USE_GUI ,
										config.NUM_OBSTACLE,
...
paths.append(gravity.bettergravity(obstacle_list, waypoint_list, config.FIELD_HEIGHT, config.FIELD_WIDTH))
